...
import { StagePill, trailerTypePillClasses, inspectionTone, fmtDate } from './fleetUtils'
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <input
          ...
          placeholder="Search unit, VIN, type, plate, driver…"
          value={filter}
            ...
            <tbody>
              {loading ? (
                ...
                <tr><td colSpan={9} className="px-4 py-12 text-center text-gray-400 dark:text-slate-600 text-sm">
                  {rows.length === 0
                    ? "No trailers yet. Click 'Add Trailer' to add your first one, or wait for PR 2 to upload an Excel report."
